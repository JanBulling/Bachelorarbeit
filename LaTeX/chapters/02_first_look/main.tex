...
One possibility is, to use internal or external non-linearities such as a spin degree of freedoms in a Stern-Gerlach apparatus with magnetic field gradient \cite{Bose_2017}.
...
The masses are prepared in a coherent delocalized quantum superposition of Schrödinger-cat-like states in, for now, an orientation, where they are perfectly parallel to each other as seen in \cref{fig:2:simple-problem}.
