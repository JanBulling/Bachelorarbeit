...
It is possible to determine the asymptotic increase of frequencies $\omega_{kl}$ with the mode numbers $k,l \rightarrow \infty$.
...
\end{equation}
implying that the first zero $\tilde{r}_1$ shift outwards with $\tilde{r}_1 \gtrsim 2l/e$.
...
Additionally, the shape $u_{kl}$ of higher modes has more bulges, limiting the amplitude further as the available shield-material is distributed over smaller segments of the plate.
