...
Strictly spoken, to generate generate cat-state superpositions a non-harmonic potential like e.g. a \q{double well potential} is required. In the parallel orientation, the double wells are also oriented parallel to the shield resulting in a almost-harmonic potential from the side-few as seen in \cref{fig:4:trap-eigenstates}.
