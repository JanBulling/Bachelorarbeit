...
Considering these results, the parallel orientation seems to be the more stable and therefore favorable option, even if the requires coherence times $t_\mathrm{max}$ are twice as long.
