...
\renewcommand{\arraystretch}{1.25}   %% Additional space between table rows (Default 1)
...
\input{chapters/02_first_look/main.tex}
\input{chapters/03_casimir/main.tex}
\input{chapters/04_static_shield/main.tex}
\input{chapters/05_shield/main.tex}
\input{chapters/06_discussion/main.tex}
...
% \input{sections/apx_00_proofs.tex}
\input{chapters/appendix/apx_01_a_first_look.tex}
\input{chapters/appendix/apx_02_casimir.tex}
\input{chapters/appendix/apx_03_shield.tex}
\input{chapters/appendix/apx_04_calculations.tex}
